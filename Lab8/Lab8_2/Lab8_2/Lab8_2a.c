...
;Description: GENERATING A WAVEFORM WITH A LOOKUP TABLE
;*********************************INCLUDES**************************************/
#include <avr/io.h>
...
#define period ((32000000/256/1) / 1000)
//1000Hz -> (32MHz/256)/1000Hz

//Global Variable
volatile uint8_t count = 0;	//Goes through the sin
