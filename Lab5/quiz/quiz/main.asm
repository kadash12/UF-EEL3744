...
.equ usart = 0b00110011		;asynch, 8 data, even, 1 stat, 1 stop
.EQU BSel = 5	
.EQU BScale = -1	;36000 Hz
.equ random = 0x07
...
POLL:
	...
	sts USARTD0_DATA, R20		;send the character out over the USART
...
Write:
	...
	lds R20, USARTD0_DATA		;read the character into R16
